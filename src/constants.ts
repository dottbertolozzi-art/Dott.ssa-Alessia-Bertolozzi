...
export const PROFILES: Profile[] = [
  {
    ...
    mirrorEffect: "Ti senti generalmente bene, hai energia e il tuo ciclo non ti dà grandi preoccupazioni. Sei qui perché sei una persona attenta e vuoi capire se c'è qualcosa che puoi migliorare per sentirti ancora meglio o per prepararti a una fase futura.",
  ...
  {
    id: 2,
    name: "Equilibrio fragile / silente",
    mainMessage: "Il tuo corpo ti sta mandando dei sussurri. Ascoltarli ora farà tutta la differenza.",
    mirrorEffect: "Ti senti bene, ma basta una settimana più intensa o un pasto sregolato per farti sentire subito gonfia o stanca. Forse il ciclo è cambiato un po' o noti che la tua pelle non è più quella di una volta. \"È solo un periodo\", ti dici spesso.",
  ...
  },
  {
    ...
    mirrorEffect: "Ti svegli già stanca, hai cali di concentrazione nel pomeriggio e una voglia di dolci che a volte non riesci a controllare. Senti che il tuo corpo sta faticando a gestire il peso e che la tua pancia è spesso tesa, come se fosse sempre in allerta.",
  ...
  {
    id: 4,
    name: "Squilibrio ormonale disallineato",
    mainMessage: "Il tuo ciclo e la tua fertilità ti stanno parlando. È ora di rimettere ordine nel tuo dialogo interno.",
    mirrorEffect: "Il ciclo è diventato un appuntamento temuto, tra dolori, irregolarità o sindromi premestruali pesanti. Se cerchi una gravidanza, senti che il tempo passa e la confusione aumenta. Ti senti 'sballata' e non riconosci più i ritmi del tuo corpo.",
  ...
  },
  {
    ...
    mirrorEffect: "Ti senti completamente esausta, come se ogni cellula remasse contro di te. La pancia è un problema costante, il ciclo è un miraggio o un incubo, e la tua mente è annebbiata. Hai la sensazione di aver perso il controllo sulla tua salute e sulla tua vita.",
